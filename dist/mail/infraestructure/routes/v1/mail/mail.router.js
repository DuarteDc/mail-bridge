...
const parse_files_middleware_1 = require("../../../middleware/parse-files.middleware");
const mailRouter = (0, express_1.Router)();
const parseFilesMiddleware = new parse_files_middleware_1.ParseFilesMiddleware();
...
mailRouter.post('/send', uploadManager.array('attachments'), parseFilesMiddleware.parse, baseRequest.validate(mail_schema_1.MailSchema.rules()).bind(baseRequest), mailController.send);
